...
>
    ...
    <div class="space-y-1 mt-4 pt-4 border-t border-slate-200 dark:border-slate-700 flex-shrink-0">
        ...
        <!-- Get Help -->
        <a href="{{ route('gethelp') }}" class="flex items-center gap-3 px-4 py-2 rounded-xl transition text-slate-600 dark:text-slate-400 hover:bg-slate-900/10 dark:hover:bg-slate-800">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
